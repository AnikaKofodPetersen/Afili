	...
	run:
		...
		for errorfile in os.listdir("{}".format(scripts)):
			if errorfile == "end_snakemake":
				os.system("""echo "NO MATCHES FOUND: There were no homologue matches in the database to your query" >> output.log""")
				os.system("""echo "Will not be able to produce the neccessary files." >> output.log""")
